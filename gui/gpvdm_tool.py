...
def command_args_tool(argc,argv):
	...
	if argc>=2:
		if args.version:
			...
			exit(0)
		elif args.token_insert_top:
			print(args.token_insert_top)
			device_lib_token_insert_top(args.token_insert_top[0],args.token_insert_top[1],args.token_insert_top[2])
			exit(0)
