...
class ribbon_thermal(QToolBar):
	def __init__(self):
		...
		self.boundry = QAction_lock("boundry", _("Boundry\nConditions"), self,"ribbon_thermal_boundry")
		self.boundry.clicked.connect(self.callback_boundry)
		self.addAction(self.boundry)
	...
	def callback_boundry(self):
		self.config_window=class_config_window(title=_("Thermal boundry conditions"),icon="thermal")
		self.config_window.files=["thermal_boundry.inp"]
		self.config_window.description=[_("Thermal boundry conditions")]
