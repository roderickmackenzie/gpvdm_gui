	...
	def __init__(self):
		...
		try:
			...
			if number<len(bib.refs):
				...
				self.setText("<b>Please cite,</b> "+text+" when using gpvdm in your work.  And any 2 other paers listed <a href=\"https://scholar.google.co.uk/citations?user=jgQqfLsAAAAJ&hl=en\">here.</a>")
		except:
			pass
